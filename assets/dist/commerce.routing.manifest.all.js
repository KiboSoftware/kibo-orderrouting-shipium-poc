...
},{"./domains/commerce.routing/http.commerce.routing.suggestion.before":2}],2:[function(require,module,exports){
...
},{"@kibocommerce/rest-sdk":17,"@kibocommerce/rest-sdk/clients/OrderRouting":15}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KiboApiContext = exports.KiboHostedContext = void 0;
const utilities_1 = require("../utilities");
class KiboHostedContext {
    context;
    config;
    constructor(context) {
...
exports.KiboHostedContext = KiboHostedContext;
class KiboApiContext {
    context;
    constructor(context) {
        this.context = context;
    }
    get apiHost() {
        return (0, utilities_1.getTenantHostFromConfig)(this.context);
    }
    get authHost() {
...
exports.KiboApiContext = KiboApiContext;
...
const utilities_1 = require("../utilities");
const sdk_authentication_1 = require("@kibocommerce/sdk-authentication");
const tenant_data_manager_1 = require("./tenant-data-manager");
const isomorphic_fetch_1 = __importDefault(require("isomorphic-fetch"));
const api_context_1 = require("./api-context");
class Configuration {
    isKiboHosted;
    context;
    middleware;
    ...
    fetchApi;
    constructor(params) {
        this.isKiboHosted = (0, utilities_1.isKiboHosted)();
        this.middleware = params.middleware || [];
        this.fetchApi = params.fetchApi || isomorphic_fetch_1.default;
        if (this.isKiboHosted) {
            this.context = new api_context_1.KiboHostedContext(params.apiContext);
        }
        else {
            this.context = new api_context_1.KiboApiContext(params);
            const { sharedSecret, clientId, authHost = utilities_1.constants.defaults.AUTH_HOST } = this.context;
            if (sharedSecret && clientId && authHost) {
                const cacheHandler = {
                    getAuthTicket: async () => {
                        return utilities_1.apiAuthMemCache.getAuthTicket(clientId);
                    },
                    setAuthTicket: async (authTicket) => {
                        await utilities_1.apiAuthMemCache.setAuthTicket(clientId, authTicket);
                    },
                };
                this._authClient = new sdk_authentication_1.APIAuthClient({ sharedSecret, clientId, authHost }, this.fetchApi, cacheHandler);
                this._tenantDataManager = new tenant_data_manager_1.TenantManager(this._authClient, authHost, params.fetchApi);
            }
        }
    }
    get appClaims() {
    ...
    get headers() {
        return (0, utilities_1.getApiHeaders)(this.context);
    }
    get queryParamsStringify() {
        return index_1.querystring;
    }
    get accessToken() {
        const accessToken = this.context.accessToken;
        if (accessToken) {
    ...
    async getBaseAPIUrl(template) {
        ...
        return (0, utilities_1.getTenantApiUrl)(this.context) + '/api';
    }
    static fromEnv() {
        return new Configuration((0, utilities_1.getConfigFromEnv)());
    }
}
exports.Configuration = Configuration;

},{"../utilities":23,"./api-context":3,"./index":5,"./tenant-data-manager":6,"@kibocommerce/sdk-authentication":25,"isomorphic-fetch":74}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.TextApiResponse = exports.BlobApiResponse = exports.VoidApiResponse = exports.JSONApiResponse = exports.canConsumeForm = exports.querystring = exports.COLLECTION_FORMATS = exports.RequiredError = exports.FetchError = exports.ResponseError = exports.BaseAPI = void 0;
class BaseAPI {
    middleware;
    basePathTemplate;
    configuration;
    ...
    async addAuthorizationHeaders(headers) {
    ...
    async request(context, initOverrides) {
        ...
        throw new ResponseError(response, apiError?.message || 'Response returned an error code', apiError);
    }
            ...
            if (middleware.post) {
                ...
                response =
                    (await middleware.post({
                        ...
                        url: fetchParams.url,
                        init: fetchParams.init,
                        response: partialClonedResponse,
                    })) || response;
            }
        }
        return response;
...
class ResponseError extends Error {
    ...
    response;
    name = 'ResponseError';
    constructor(response, msg, apiError) {
        super(msg);
...
const isomorphic_fetch_1 = __importDefault(require("isomorphic-fetch"));
const tenant_data_mem_cache_1 = require("../utilities/tenant-data-mem-cache");
class TenantManager {
    _sdkAuth;
    _homeApiUrl;
    _fetchApi;
    constructor(sdkAuth, homeHost, fetchApi = isomorphic_fetch_1.default) {
        if (!sdkAuth) {
    ...
    async getTenant(tenantId) {
        try {
            if (tenant_data_mem_cache_1.tenantDataMemCache.has(tenantId.toString())) {
                return tenant_data_mem_cache_1.tenantDataMemCache.get(tenantId.toString());
            }
            ...
            tenant_data_mem_cache_1.tenantDataMemCache.set(tenantId.toString(), tenant);
            return tenant;
        }
        catch (error) {
            throw error;
    ...
    async getSite({ tenantId, siteId }) {
        ...
        const site = tenant.sites.find((site) => site.siteId == siteId);
        if (!site) {
...
},{"../utilities/tenant-data-mem-cache":24,"isomorphic-fetch":74}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.basePathTemplate = void 0;
exports.basePathTemplate = 'https://t{tenantId}.{env}.mozu.com/api';
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderRoutingDataListApi = void 0;
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class OrderRoutingDataListApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async createCustomDataListRaw(requestParameters, initOverrides) {
    ...
    async createCustomDataList(requestParameters, initOverrides) {
        const response = await this.createCustomDataListRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async deleteCustomDataListRaw(requestParameters, initOverrides) {
    ...
    async deleteCustomDataList(requestParameters, initOverrides) {
        await this.deleteCustomDataListRaw(requestParameters, initOverrides);
    }
    async getCustomDataListRaw(requestParameters, initOverrides) {
        if (requestParameters.dataListID === null || requestParameters.dataListID === undefined) {
    ...
    async getCustomDataList(requestParameters, initOverrides) {
        const response = await this.getCustomDataListRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async updateCustomDataListRaw(requestParameters, initOverrides) {
        if (requestParameters.dataListID === null || requestParameters.dataListID === undefined) {
    ...
    async updateCustomDataList(requestParameters, initOverrides) {
        const response = await this.updateCustomDataListRaw(requestParameters, initOverrides);
        return await response.value();
    }
}
exports.OrderRoutingDataListApi = OrderRoutingDataListApi;

},{"../../../client-runtime":5,"../api-path":7}],9:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderRoutingFilterApi = void 0;
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class OrderRoutingFilterApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async deleteFilterRaw(requestParameters, initOverrides) {
    ...
    async deleteFilter(requestParameters, initOverrides) {
        await this.deleteFilterRaw(requestParameters, initOverrides);
    }
    async getFilterRaw(requestParameters, initOverrides) {
        if (requestParameters.filterID === null || requestParameters.filterID === undefined) {
    ...
    async getFilter(requestParameters, initOverrides) {
        const response = await this.getFilterRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async saveCriteriaSetFilterRaw(requestParameters, initOverrides) {
    ...
    async saveCriteriaSetFilter(requestParameters, initOverrides) {
        const response = await this.saveCriteriaSetFilterRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async saveCustomDataListFilterRaw(requestParameters, initOverrides) {
    ...
    async saveCustomDataListFilter(requestParameters, initOverrides) {
        const response = await this.saveCustomDataListFilterRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async saveCustomDataValueFilterRaw(requestParameters, initOverrides) {
    ...
    async saveCustomDataValueFilter(requestParameters, initOverrides) {
        const response = await this.saveCustomDataValueFilterRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async testFilterRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        await this.addAuthorizationHeaders(headerParameters);
        const response = await this.request({
    ...
    async testFilter(initOverrides) {
        const response = await this.testFilterRaw(initOverrides);
        return await response.value();
    }
    async testSetFilterRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        await this.addAuthorizationHeaders(headerParameters);
        const response = await this.request({
    ...
    async testSetFilter(initOverrides) {
        const response = await this.testSetFilterRaw(initOverrides);
        return await response.value();
    }
}
exports.OrderRoutingFilterApi = OrderRoutingFilterApi;

},{"../../../client-runtime":5,"../api-path":7}],10:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderRoutingGroupApi = void 0;
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class OrderRoutingGroupApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async deleteGroupRaw(requestParameters, initOverrides) {
    ...
    async deleteGroup(requestParameters, initOverrides) {
    ...
    async saveGroupRaw(requestParameters, initOverrides) {
        if (requestParameters.loc === null || requestParameters.loc === undefined) {
    ...
    async saveGroup(requestParameters, initOverrides) {
        const response = await this.saveGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async setGroupFiltersRaw(requestParameters, initOverrides) {
        if (requestParameters.groupID === null || requestParameters.groupID === undefined) {
    ...
    async setGroupFilters(requestParameters, initOverrides) {
        const response = await this.setGroupFiltersRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async setGroupSortsRaw(requestParameters, initOverrides) {
        if (requestParameters.groupID === null || requestParameters.groupID === undefined) {
    ...
    async setGroupSorts(requestParameters, initOverrides) {
        const response = await this.setGroupSortsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async testGroupRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        await this.addAuthorizationHeaders(headerParameters);
        const response = await this.request({
    ...
    async testGroup(initOverrides) {
        const response = await this.testGroupRaw(initOverrides);
        return await response.value();
    }
}
exports.OrderRoutingGroupApi = OrderRoutingGroupApi;

},{"../../../client-runtime":5,"../api-path":7}],11:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderRoutingLocationApi = void 0;
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class OrderRoutingLocationApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async getLocationByLocationCodeRaw(requestParameters, initOverrides) {
    ...
    async getLocationByLocationCode(requestParameters, initOverrides) {
...
exports.OrderRoutingLocationApi = OrderRoutingLocationApi;

},{"../../../client-runtime":5,"../api-path":7}],12:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.OrderRoutingSettingsApi = void 0;
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class OrderRoutingSettingsApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async deleteFilterAttributeRaw(requestParameters, initOverrides) {
    ...
    async deleteFilterAttribute(requestParameters, initOverrides) {
        const response = await this.deleteFilterAttributeRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async deleteSettingsRaw(requestParameters, initOverrides) {
    ...
    async deleteSettings(requestParameters, initOverrides) {
        const response = await this.deleteSettingsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async getFilterAttributeRaw(requestParameters, initOverrides) {
        if (requestParameters.attributeName === null || requestParameters.attributeName === undefined) {
    ...
    async getFilterAttribute(requestParameters, initOverrides) {
        const response = await this.getFilterAttributeRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async getFilterAttributesRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        await this.addAuthorizationHeaders(headerParameters);
        const response = await this.request({
    ...
    async getFilterAttributes(initOverrides) {
        const response = await this.getFilterAttributesRaw(initOverrides);
        return await response.value();
    }
    async getSettingsRaw(requestParameters, initOverrides) {
        const queryParameters = {};
    ...
    async saveFilterAttributeRaw(requestParameters, initOverrides) {
    ...
    async saveFilterAttribute(requestParameters, initOverrides) {
        const response = await this.saveFilterAttributeRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async saveSettingsRaw(requestParameters, initOverrides) {
    ...
    async saveSettings(requestParameters, initOverrides) {
        const response = await this.saveSettingsRaw(requestParameters, initOverrides);
        return await response.value();
    }
}
exports.OrderRoutingSettingsApi = OrderRoutingSettingsApi;

},{"../../../client-runtime":5,"../api-path":7}],13:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
const runtime = __importStar(require("../../../client-runtime"));
const api_path_1 = require("../api-path");
class RoutingApi extends runtime.BaseAPI {
    constructor(configuration) {
        super(configuration);
        this.basePathTemplate = api_path_1.basePathTemplate;
    }
    async getSampleRequestRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        await this.addAuthorizationHeaders(headerParameters);
        const response = await this.request({
    ...
    async getSampleRequest(initOverrides) {
        const response = await this.getSampleRequestRaw(initOverrides);
        return await response.value();
    }
    async getSuggestionLogRaw(requestParameters, initOverrides) {
        const queryParameters = {};
    ...
    async getSuggestionLog(requestParameters = {}, initOverrides) {
        const response = await this.getSuggestionLogRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async suggestCandidatesRaw(requestParameters, initOverrides) {
    ...
    async suggestCandidates(requestParameters, initOverrides) {
        const response = await this.suggestCandidatesRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async suggestRoutingRaw(requestParameters, initOverrides) {
        if (requestParameters.request === null || requestParameters.request === undefined) {
    ...
    async suggestRouting(requestParameters, initOverrides) {
        const response = await this.suggestRoutingRaw(requestParameters, initOverrides);
        return await response.value();
    }
    async suggestRoutingTestRaw(requestParameters, initOverrides) {
        if (requestParameters.request === null || requestParameters.request === undefined) {
    ...
    async suggestRoutingTest(requestParameters, initOverrides) {
...
},{"../../../client-runtime":5,"../api-path":7}],14:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(require("./OrderRoutingDataListApi"), exports);
__exportStar(require("./OrderRoutingFilterApi"), exports);
__exportStar(require("./OrderRoutingGroupApi"), exports);
__exportStar(require("./OrderRoutingLocationApi"), exports);
__exportStar(require("./OrderRoutingSettingsApi"), exports);
__exportStar(require("./RoutingApi"), exports);

},{"./OrderRoutingDataListApi":8,"./OrderRoutingFilterApi":9,"./OrderRoutingGroupApi":10,"./OrderRoutingLocationApi":11,"./OrderRoutingSettingsApi":12,"./RoutingApi":13}],15:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
},{"./apis":14,"./models":16}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SuggestionResponseRouteEnum = exports.SuggestionRequestOrderTypeEnum = exports.SuggestionRequestInventoryRequestTypeEnum = exports.SuggestionRequestBundlingStrategyEnum = exports.SuggestionEventTypeEnum = exports.StateChangeSuggestionStateChangeEnum = exports.OrderRoutingSettingsTooManyAssignsActionEnum = exports.OrderRoutingSettingsProductIdentifierMappingEnum = exports.OrderRoutingSettingsFailoverActionsEnum = exports.OrderRoutingSettingsDefaultStateChangeEnum = exports.LocationSortSortingTypeEnum = exports.LocationCriteriaSetFilterBooleanOperatorEnum = exports.LocationCriteriaSetReadyStateEnum = exports.GroupAfterActionRestartAttemptEnum = exports.GroupAfterActionFailoverActionEnum = exports.FulfillmentLimitFulfillmentTypeEnum = exports.FulfillmentLimitDurationTypeEnum = exports.FilterAttributeUnitTypeEnum = exports.FilterAttributeFilterTypeGroupEnum = exports.CustomDataValueFilterBooleanOperatorEnum = exports.CustomDataListResponseStateEnum = exports.CustomDataListResponseDataTypeEnum = exports.CustomDataListFilterBooleanOperatorEnum = exports.CustomDataListStateEnum = exports.CustomDataListDataTypeEnum = exports.CandidateSuggestionsRequestOrderTypeEnum = exports.CandidateSuggestionsRequestInventoryRequestTypeEnum = exports.AssignmentSuggestionRouteEnum = exports.AbstractFilterBooleanOperatorEnum = void 0;
exports.AbstractFilterBooleanOperatorEnum = {
...
exports.AssignmentSuggestionRouteEnum = {
    Directship: 'DIRECTSHIP',
    Transfer: 'TRANSFER',
    SthConsolidated: 'STH_CONSOLIDATED'
};
exports.CandidateSuggestionsRequestInventoryRequestTypeEnum = {
    All: 'ALL',
    Partial: 'PARTIAL',
    Any: 'ANY',
    AllStores: 'ALL_STORES'
};
exports.CandidateSuggestionsRequestOrderTypeEnum = {
    Directship: 'DIRECTSHIP',
    Transfer: 'TRANSFER',
    SthConsolidated: 'STH_CONSOLIDATED'
};
exports.CustomDataListDataTypeEnum = {
    String: 'STRING',
    Number: 'NUMBER',
    Location: 'LOCATION',
    Date: 'DATE'
};
exports.CustomDataListStateEnum = {
    Ready: 'dataset.ready',
    Processing: 'dataset.processing',
    ErrorProcessing: 'dataset.error.processing'
};
exports.CustomDataListFilterBooleanOperatorEnum = {
    Equal: 'filter.logic.equal',
    NotEqual: 'filter.logic.not.equal',
    GreaterThan: 'filter.logic.greater.than',
    LessThan: 'filter.logic.less.than',
...
exports.CustomDataListResponseDataTypeEnum = {
    String: 'STRING',
    Number: 'NUMBER',
    Location: 'LOCATION',
    Date: 'DATE'
...
exports.CustomDataValueFilterBooleanOperatorEnum = {
    Equal: 'filter.logic.equal',
    NotEqual: 'filter.logic.not.equal',
    GreaterThan: 'filter.logic.greater.than',
    LessThan: 'filter.logic.less.than',
...
exports.FilterAttributeFilterTypeGroupEnum = {
...
exports.FilterAttributeUnitTypeEnum = {
...
exports.FulfillmentLimitDurationTypeEnum = {
    Hours: 'HOURS',
    Days: 'DAYS',
    Weeks: 'WEEKS',
    Months: 'MONTHS'
};
exports.FulfillmentLimitFulfillmentTypeEnum = {
    Orders: 'ORDERS',
    Items: 'ITEMS',
    Dollars: 'DOLLARS'
};
exports.GroupAfterActionFailoverActionEnum = {
...
exports.GroupAfterActionRestartAttemptEnum = {
    StartAtBeginning: 'START_AT_BEGINNING',
    CurrentGroup: 'CURRENT_GROUP',
    GroupRank: 'GROUP_RANK'
};
exports.LocationCriteriaSetReadyStateEnum = {
    Ready: 'dataset.ready',
    Processing: 'dataset.processing',
    ErrorProcessing: 'dataset.error.processing'
};
exports.LocationCriteriaSetFilterBooleanOperatorEnum = {
    Equal: 'filter.logic.equal',
    NotEqual: 'filter.logic.not.equal',
    GreaterThan: 'filter.logic.greater.than',
    LessThan: 'filter.logic.less.than',
...
exports.LocationSortSortingTypeEnum = {
    Rank: 'RANK',
    Distance: 'DISTANCE',
    Ltd: 'LTD',
    Cost: 'COST',
...
exports.OrderRoutingSettingsDefaultStateChangeEnum = {
    Cancel: 'CANCEL',
    CustomerCare: 'CUSTOMER_CARE',
    Available: 'AVAILABLE',
    Backorder: 'BACKORDER'
};
exports.OrderRoutingSettingsFailoverActionsEnum = {
    LineItemSplitAssignIfFulfilled: 'LINE_ITEM_SPLIT_ASSIGN_IF_FULFILLED',
    LineItemSplitCancelWithoutInventory: 'LINE_ITEM_SPLIT_CANCEL_WITHOUT_INVENTORY',
    QuantitySplitAssignIfFulfilled: 'QUANTITY_SPLIT_ASSIGN_IF_FULFILLED',
    QuantitySplitCancelWithoutInventory: 'QUANTITY_SPLIT_CANCEL_WITHOUT_INVENTORY',
...
exports.OrderRoutingSettingsProductIdentifierMappingEnum = {
...
exports.OrderRoutingSettingsTooManyAssignsActionEnum = {
    Cancel: 'CANCEL',
    CustomerCare: 'CUSTOMER_CARE',
    Available: 'AVAILABLE',
    Backorder: 'BACKORDER'
};
exports.StateChangeSuggestionStateChangeEnum = {
    Cancel: 'CANCEL',
    CustomerCare: 'CUSTOMER_CARE',
    Available: 'AVAILABLE',
    Backorder: 'BACKORDER'
};
exports.SuggestionEventTypeEnum = {
...
exports.SuggestionRequestBundlingStrategyEnum = {
    ItemDependency: 'ITEM_DEPENDENCY'
};
exports.SuggestionRequestInventoryRequestTypeEnum = {
    All: 'ALL',
    Partial: 'PARTIAL',
    Any: 'ANY',
    AllStores: 'ALL_STORES'
};
exports.SuggestionRequestOrderTypeEnum = {
    Directship: 'DIRECTSHIP',
    Transfer: 'TRANSFER',
    SthConsolidated: 'STH_CONSOLIDATED'
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Configuration = void 0;
var configuration_1 = require("./client-runtime/configuration");
Object.defineProperty(exports, "Configuration", { enumerable: true, get: function () { return configuration_1.Configuration; } });

},{"./client-runtime/configuration":4}],18:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.apiAuthMemCache = void 0;
const node_cache_1 = __importDefault(require("node-cache"));
const defaultTTL = 60 * 60 * 3;
const authTicketMemCache = new node_cache_1.default();
const apiAuthMemCache = {
    getAuthTicket: async (cacheKey) => authTicketMemCache.has(cacheKey) && authTicketMemCache.get(cacheKey),
    setAuthTicket: (cacheKey, data) => authTicketMemCache.set(cacheKey, data, data.expires_in || defaultTTL),
};
exports.apiAuthMemCache = apiAuthMemCache;

},{"node-cache":75}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const constants = {
    dataViewModes: {
    ...
    headers: {
        CORRELATION: 'x-vol-correlation',
        TENANT: 'x-vol-tenant',
        SITE: 'x-vol-site',
        MASTER_CATALOG: 'x-vol-master-catalog',
        CATALOG: 'x-vol-catalog',
        DATAVIEW_MODE: 'x-vol-dataview-mode',
        VERSION: 'x-vol-version',
    },
    defaults: {
        AUTH_HOST: 'home.mozu.com',
        PCI_HOST: 'pmts.mozu.com',
    },
};
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.getApiHeaders = void 0;
const getApiHeaders = (context) => {
    return {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.getTenantApiUrl = exports.getTenantHostFromConfig = void 0;
const getEnvironmentType = (config) => {
    if (config.apiEnv) {
...
const getRegionPart = (config) => {
    if (config.region?.startsWith('eu')) {
        return config.region;
    }
    return;
};
const getTopLevelDomainForRegion = (config) => {
    if (config.region?.startsWith('eu')) {
        return 'kibocommerce.com';
    }
    return 'mozu.com';
};
const getTenantAndSiteFromConfig = (config) => {
    if (config.tenantId && config.siteId) {
        return `t${config.tenantId}-s${config.siteId}`;
    }
    return `t${config.tenantId}`;
};
const getTenantHostFromConfig = (config) => {
    if (config.apiHost)
...
exports.getTenantHostFromConfig = getTenantHostFromConfig;
const getTenantApiUrl = (config) => {
    const tenantHost = (0, exports.getTenantHostFromConfig)(config);
    if (tenantHost.startsWith('http')) {
        return tenantHost;
    }
    return `https://${tenantHost}`;
};
exports.getTenantApiUrl = getTenantApiUrl;
...
const getConfigFromEnv = () => {
    return {
        ...
        dataViewMode: process.env.KIBO_DATA_VIEW_MODE || constants_1.default.dataViewModes.LIVE,
    };
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isKiboHosted = exports.constants = exports.tenantDataMemCache = exports.apiAuthMemCache = exports.getApiHeaders = exports.getTenantHostFromConfig = exports.getTenantApiUrl = exports.getConfigFromEnv = void 0;
var get_config_from_env_1 = require("./get-config-from-env");
Object.defineProperty(exports, "getConfigFromEnv", { enumerable: true, get: function () { return get_config_from_env_1.getConfigFromEnv; } });
var get_api_url_1 = require("./get-api-url");
Object.defineProperty(exports, "getTenantApiUrl", { enumerable: true, get: function () { return get_api_url_1.getTenantApiUrl; } });
Object.defineProperty(exports, "getTenantHostFromConfig", { enumerable: true, get: function () { return get_api_url_1.getTenantHostFromConfig; } });
var get_api_headers_1 = require("./get-api-headers");
Object.defineProperty(exports, "getApiHeaders", { enumerable: true, get: function () { return get_api_headers_1.getApiHeaders; } });
var api_auth_mem_cache_1 = require("./api-auth-mem-cache");
Object.defineProperty(exports, "apiAuthMemCache", { enumerable: true, get: function () { return api_auth_mem_cache_1.apiAuthMemCache; } });
var tenant_data_mem_cache_1 = require("./tenant-data-mem-cache");
Object.defineProperty(exports, "tenantDataMemCache", { enumerable: true, get: function () { return tenant_data_mem_cache_1.tenantDataMemCache; } });
...
exports.isKiboHosted = isKiboHosted;

},{"./api-auth-mem-cache":18,"./constants":19,"./get-api-headers":20,"./get-api-url":21,"./get-config-from-env":22,"./tenant-data-mem-cache":24}],24:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.tenantDataMemCache = void 0;
const node_cache_1 = __importDefault(require("node-cache"));
const defaultTTL = 60 * 60;
const tenantMemCache = new node_cache_1.default();
const tenantDataMemCache = {
    get: async (cacheKey) => tenantMemCache.get(cacheKey),
    set: (cacheKey, data) => tenantMemCache.set(cacheKey, data, defaultTTL),
    has: (cacheKey) => tenantMemCache.has(cacheKey),
};
exports.tenantDataMemCache = tenantDataMemCache;

},{"node-cache":75}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.APIAuthClient = void 0;
const util_1 = require("./util");
class APIAuthClient {
    constructor({ clientId, sharedSecret, authHost }, fetcher, authTicketCache, isInternal) {
        if (!clientId || !sharedSecret || !authHost) {
            throw new Error("Kibo API Auth client requires a clientId, sharedSecret, and authUrl");
        }
        if (!fetcher) {
            throw new Error("Kibo API Auth client requires a Fetch API implementation");
        }
        this._clientId = clientId;
        this._sharedSecret = sharedSecret;
        this._authHost = util_1.addProtocolToHost(authHost);
    ...
    _buildFetchOptions(body = {}) {
        return Object.assign({ method: "POST", headers: {
                "Content-Type": "application/json",
            }, body: JSON.stringify(body) }, util_1.getProxyAgent());
    }
    async _fetchAuthTicket(url, options) {
        ...
        if ((response === null || response === void 0 ? void 0 : response.status) >= 500) {
            throw new Error(response === null || response === void 0 ? void 0 : response.statusText);
        }
        const authTicket = (await response.json());
        if (authTicket === null || authTicket === void 0 ? void 0 : authTicket.errorCode) {
            throw new Error(authTicket.message);
        }
        // set expiration time in ms on auth ticket
        authTicket.expires_at = util_1.calculateTicketExpiration(authTicket);
        return authTicket;
    }
    async authenticate() {
        var _a;
        ...
        const authTicket = await this._fetchAuthTicket(`${this._authHost}${path}`, options);
        // set authentication ticket on next server runtime object
        (_a = this._authTicketCache) === null || _a === void 0 ? void 0 : _a.setAuthTicket(authTicket);
        return authTicket;
    }
    async refreshTicket(kiboAuthTicket) {
        ...
        const options = this._buildFetchOptions({
            ...
            client_secret: this._sharedSecret,
            grant_type: "client_credentials",
            refresh_token: kiboAuthTicket === null || kiboAuthTicket === void 0 ? void 0 : kiboAuthTicket.refresh_token,
        });
        ...
        const refreshedTicket = await this._fetchAuthTicket(`${this._authHost}${path}`, options);
        // set authentication ticket on next server runtime object
        (_a = this._authTicketCache) === null || _a === void 0 ? void 0 : _a.setAuthTicket(refreshedTicket);
    ...
    async getAccessToken() {
        ...
        try {
            let authTicket = await ((_a = this._authTicketCache) === null || _a === void 0 ? void 0 : _a.getAuthTicket());
            ...
            return authTicket === null || authTicket === void 0 ? void 0 : authTicket.access_token;
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getApiConfigFromEnv = exports.formatConfigHostnames = exports.addProtocolToHost = exports.makeKiboAPIHeaders = exports.getKiboHostedConfig = exports.isShopperAuthExpired = exports.normalizeShopperAuthResponse = exports.getHostFromUrl = exports.isValidConfig = exports.getProxyAgent = exports.calculateTicketExpiration = void 0;
...
const calculateTicketExpiration = (kiboAuthTicket) => Date.now() + kiboAuthTicket.expires_in * 1000;
exports.calculateTicketExpiration = calculateTicketExpiration;
const getProxyAgent = () => {
    let options = { agent: null };
    if (process.env.HTTPS_PROXY || process.env.HTTP_PROXY) {
        process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
        options.agent = process.env.HTTP_PROXY
            ? new http_proxy_agent_1.default.HttpProxyAgent(process.env.HTTP_PROXY)
            : new https_proxy_agent_1.default.HttpsProxyAgent(process.env.HTTPS_PROXY);
    }
    return options;
};
...
const normalizeShopperAuthResponse = (apiResponse) => {
    const { accessToken, accessTokenExpiration, refreshToken, userId, refreshTokenExpiration, } = apiResponse;
    return {
        accessToken,
...
exports.normalizeShopperAuthResponse = normalizeShopperAuthResponse;
const isShopperAuthExpired = (userAuthTicket) => {
    const { accessTokenExpiration } = userAuthTicket;
    return new Date(accessTokenExpiration).getTime() < Date.now();
};
exports.isShopperAuthExpired = isShopperAuthExpired;
const getKiboHostedConfig = () => {
    try {
        return JSON.parse(process.env.mozuHosted).sdkConfig;
    }
    catch (error) {
        throw new Error("Error parsing Kibo Hosted environment variables: " + error.message);
    }
};
exports.getKiboHostedConfig = getKiboHostedConfig;
const makeKiboAPIHeaders = (kiboHostedConfig) => {
    return Object.values(constants.headers).reduce((accum, headerSuffix) => {
...
exports.makeKiboAPIHeaders = makeKiboAPIHeaders;
const protocolRegx = new RegExp(/https?:\/\//);
const addProtocolToHost = (hostname) => hostname && !hostname.match(protocolRegx) ? `https://${hostname}` : hostname;
exports.addProtocolToHost = addProtocolToHost;
const formatConfigHostnames = (config) => {
    const { apiHost, authHost } = config, creds = __rest(config, ["apiHost", "authHost"]);
    return Object.assign({ apiHost: exports.addProtocolToHost(apiHost), authHost: exports.addProtocolToHost(authHost) }, creds);
};
exports.formatConfigHostnames = formatConfigHostnames;
const getApiConfigFromEnv = () => ({
    clientId: process.env.KIBO_CLIENT_ID,
    sharedSecret: process.env.KIBO_SHARED_SECRET,
    authHost: process.env.KIBO_AUTH_HOST,
    apiHost: process.env.KIBO_API_HOST,
});
exports.getApiConfigFromEnv = getApiConfigFromEnv;

},{"http-proxy-agent":39,"https-proxy-agent":46}],27:[function(require,module,exports){
"use strict";
function noop() { }
...
},{"./promisify":29,"debug":32,"events":undefined}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./browser.js":30,"./node.js":33}],33:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./common":31,"supports-color":79,"tty":undefined,"util":undefined}],34:[function(require,module,exports){
/**
 * Helpers.
 */
...
},{"iconv-lite":72}],37:[function(require,module,exports){
'use strict';
...
},{"@tootallnate/once":27,"agent-base":28,"debug":42,"net":undefined,"tls":undefined,"url":undefined}],39:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./agent":38}],40:[function(require,module,exports){
arguments[4][30][0].apply(exports,arguments)
},{"./common":41,"dup":30}],41:[function(require,module,exports){
arguments[4][31][0].apply(exports,arguments)
},{"dup":31,"ms":44}],42:[function(require,module,exports){
arguments[4][32][0].apply(exports,arguments)
},{"./browser.js":40,"./node.js":43,"dup":32}],43:[function(require,module,exports){
arguments[4][33][0].apply(exports,arguments)
},{"./common":41,"dup":33,"supports-color":79,"tty":undefined,"util":undefined}],44:[function(require,module,exports){
...
},{"./parse-proxy-response":47,"agent-base":28,"assert":undefined,"debug":50,"net":undefined,"tls":undefined,"url":undefined}],46:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./agent":45}],47:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
arguments[4][30][0].apply(exports,arguments)
},{"./common":49,"dup":30}],49:[function(require,module,exports){
arguments[4][31][0].apply(exports,arguments)
},{"dup":31,"ms":52}],50:[function(require,module,exports){
arguments[4][32][0].apply(exports,arguments)
},{"./browser.js":48,"./node.js":51,"dup":32}],51:[function(require,module,exports){
arguments[4][33][0].apply(exports,arguments)
},{"./common":49,"dup":33,"supports-color":79,"tty":undefined,"util":undefined}],52:[function(require,module,exports){
arguments[4][34][0].apply(exports,arguments)
...
},{"safer-buffer":78}],54:[function(require,module,exports){
"use strict";
...
},{"./dbcs-codec":53,"./dbcs-data":54,"./internal":56,"./sbcs-codec":57,"./sbcs-data":59,"./sbcs-data-generated":58,"./utf16":68,"./utf32":69,"./utf7":70}],56:[function(require,module,exports){
"use strict";
var Buffer = require("safer-buffer").Buffer;
...
},{"safer-buffer":78,"string_decoder":undefined}],57:[function(require,module,exports){
"use strict";
var Buffer = require("safer-buffer").Buffer;
...
},{"safer-buffer":78}],58:[function(require,module,exports){
"use strict";
...
},{"safer-buffer":78}],69:[function(require,module,exports){
'use strict';
...
},{"safer-buffer":78}],70:[function(require,module,exports){
"use strict";
var Buffer = require("safer-buffer").Buffer;
...
},{"safer-buffer":78}],71:[function(require,module,exports){
"use strict";
...
},{"../encodings":55,"./bom-handling":71,"./streams":73,"safer-buffer":78,"stream":undefined}],73:[function(require,module,exports){
"use strict";
...
},{"safer-buffer":78}],74:[function(require,module,exports){
"use strict";
...
},{"node-fetch":77}],75:[function(require,module,exports){
/*
...
},{"./lib/node_cache":76}],76:[function(require,module,exports){
/*
 * node-cache 5.1.2 ( 2020-07-01 )
 * https://github.com/node-cache/node-cache
 *
...
},{"clone":35,"events":undefined}],77:[function(require,module,exports){
'use strict';
...
},{"encoding":36,"http":undefined,"https":undefined,"stream":undefined,"url":undefined,"whatwg-url":85,"zlib":undefined}],78:[function(require,module,exports){
...
},{"has-flag":37,"os":undefined,"tty":undefined}],80:[function(require,module,exports){
"use strict";
...
},{"./lib/mappingTable.json":81,"punycode":undefined}],81:[function(require,module,exports){
...
},{"./url-state-machine":86}],84:[function(require,module,exports){
"use strict";
...
},{".//URL-impl.js":83,"./utils.js":87,"webidl-conversions":82}],85:[function(require,module,exports){
"use strict";
...
},{"./URL":84,"./url-state-machine":86}],86:[function(require,module,exports){
"use strict";
...
},{"punycode":undefined,"tr46":80}],87:[function(require,module,exports){
"use strict";
